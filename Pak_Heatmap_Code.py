...
@author: Jay
This code produces a correlation heatmap for Pakistan using data obtained from the World Bank website.
...
GitHub Repository: https://github.com/JawadDS/ADS_Assignment2/blob/main/Pak_Heatmap_Data.csv
...
def read_and_plot_heatmap(file_path):
    ...
    plt.title('Correlation Heatmap For Pakistan (2010-2014)')
    plt.show()

# Calling the function and passing data file
read_and_plot_heatmap('Pak_Heatmap_Data.csv')
