...
@author: Jay
This code produces a correlation heatmap for South Africa using data obtained from the World Bank website.
...
GitHub Repository: https://github.com/JawadDS/ADS_Assignment2/blob/main/South_Africa_Heatmap_data.csv
...
read_and_plot_heatmap('South_Africa_Heatmap_Data.csv')
